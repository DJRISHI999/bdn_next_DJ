...
const Slide = ({ slide, index, current, handleSlideClick }: SlideProps) => {
  ...
  const xRef = useRef(0);
  const yRef = useRef(0);
  const frameRef = useRef<number | null>(null); // Fixed: Provide an initial value of null
...
export function Carousel({ slides }: CarouselProps) {
  ...
  return (
    <div
      className="relative w-full max-w-[100vw] h-[70vmin] mx-auto"
...
export default function Hero() {
  ...
  return (
    <section className="relative bg-gray-850 text-white overflow-hidden mt-16">
